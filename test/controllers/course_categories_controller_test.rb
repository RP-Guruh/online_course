...
class CourseCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_category" do
    assert_difference("CourseCategory.count") do
      post course_categories_url, params: { course_category: { created_by: @course_category.created_by, created_by_name: @course_category.created_by_name, name: @course_category.name, note: @course_category.note, updated_by: @course_category.updated_by, updated_by_name: @course_category.updated_by_name } }
    end
  ...
  test "should update course_category" do
    patch course_category_url(@course_category), params: { course_category: { created_by: @course_category.created_by, created_by_name: @course_category.created_by_name, name: @course_category.name, note: @course_category.note, updated_by: @course_category.updated_by, updated_by_name: @course_category.updated_by_name } }
